...
const GamePage: NextPage = () => {
  return (
    <div className="relative bg-darkslategray-100 w-full h-[1024px] overflow-hidden text-left text-29xl text-base-white font-body">
      <div className="absolute top-[15px] left-[69px] w-[1301px] h-[1092px] text-181xl font-geo">
      ...
      <div className="absolute top-[15px] left-[41px] text-5xl tracking-[0.1em] inline-block w-[129px] h-[35px]">
        Points: 3
      </div>
      <div className="absolute top-[15px] left-[189px] text-5xl tracking-[0.1em] inline-block w-[198px] h-[35px]">
        Speed up: off
      </div>
